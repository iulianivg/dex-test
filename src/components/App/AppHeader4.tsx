...
<span style={{fontSize:'16px', color:'#FB5843'}}>Portfolio</span>         <a href="/portfolio"> <span style={{fontSize:'16px', marginLeft:'5px', color:'#7A7A7A'}}>NFT (coming soon)</span> </a>
<a href="/history" target="_blank" rel="noreferrer" style={{textDecoration:'none'}}>
<span style={{fontSize:'16px', marginLeft:'5px', color:'#7A7A7A'}}>History</span>
</a>
</div> 
          </Heading>
        </Flex>
