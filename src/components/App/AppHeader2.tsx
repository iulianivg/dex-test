...
const AppHeader2: React.FC<Props> = ({ title, subtitle, helper, backTo, noConfig = false }) => {
  return (
    <AppHeaderContainer>
...
<span style={{fontSize:'16px', color:'#FB5843'}}>Swap</span>         <a href="/pool"> <span style={{fontSize:'16px', marginLeft:'5px', color:'#7A7A7A'}}>Liquidity</span> </a>
